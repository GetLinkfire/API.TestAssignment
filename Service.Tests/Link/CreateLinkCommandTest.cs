...
namespace Service.Tests.Link
{
  ...
  public class CreateLinkCommandTest
  {
    ...
    public void Init()
    {
      ...
      _createLinkCommand = new CreateLinkCommand(_linkRepository, _storageService, _domainRepository, _mediaServiceRepository);
    ...
    public void Execute_WithoutCode_Music()
    {
      ...
      _linkRepository.Expect(x =>
        ...
        .WhenCalled(x =>
        {
          Repository.Entities.Link link = (Repository.Entities.Link)x.Arguments[0];
          link.IsActive = true;
          x.ReturnValue = link;
        });
